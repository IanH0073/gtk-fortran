...
contains
  ...
  function hl_gtk_entry_new(len, editable, activate, data, tooltip, value, &
       ...
       & data_focus_in, data_focus_out, size) result(entry_tmp)
    ...
    ! the function result and delete all references to entry_tmp
    type(c_ptr) :: entry_tmp
  ...
  function hl_gtk_text_view_new(scroll, editable, changed, data_changed, &
       ...
       & vscroll_policy) result(view_tmp)
