...
! --------------------------------------------------------
! gtk-hl-button.f90
! Generated: Mon Oct  6 23:48:40 2014 GMT
! Please do not edit this file directly,
! Edit gtk-hl-button-tmpl.f90, and use H:\Projects\gtk-fortran\src\mk_gtk_hl.pl to regenerate.
...
contains
  ...
  function hl_gtk_button_new(label, clicked, data, tooltip, sensitive, &
       & accel_key, accel_mods, accel_group, accel_flags, is_markup) result(but_tmp)
    ...
    ! the function result and delete all references to but_tmp
    type(c_ptr) :: but_tmp
  ...
  function hl_gtk_check_button_new(label, toggled, data, tooltip, &
       & initial_state, sensitive, is_markup, toggle) result(but_tmp)
  ...
  function hl_gtk_radio_button_new(group, label, toggled, data, tooltip, &
       & sensitive, is_markup) result(but_tmp)
